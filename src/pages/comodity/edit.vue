                ...
                <vx-form :model="form.data" :rules="form.rules" ref="ruleForm" type="vertical" label-size="2">
                  ...
                  <vx-card>
                      ...
                      <div class="text-center p-3">
                        ...
                        <div><img :src=this.form.data.image style="height:20%;width:20%"></div>
                       <label class="btn btn-primary btn-sm">
                            <input type="file" @change="onFileSelected" accept="image/*" name="com_img" style="display:none;"> Ubah Gambar
                        </label>
                      </div>  
                  </vx-card>
                  <vx-card>
