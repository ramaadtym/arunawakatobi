<template>
  <vx-container title="Tambah Pengguna">
          ...
          <vx-card>
            ...
            <div class="ks-items-block">
              <vx-form :model="form.data" :rules="form.rules" ref="ruleForm" type="vertical" label-size="2">
                ...
                <vx-form-item label="Tipe Pengguna" prop="user_group" :error="errors.user_group">
                ...
                <template slot="action">
                  <vx-button variant="primary" outline light class="mr-2" to="/users">Batal</vx-button>
